...
const tabs = [
  { name: 'Applied', href: '#', icon: UserIcon, count: '52', current: false },
  { name: 'Phone Screening', href: '#', icon: OfficeBuildingIcon, count: '6', current: false },
  { name: 'Interview', href: '#', icon: UsersIcon, count: '4', current: true },
  { name: 'Offer', href: '#', icon: CreditCardIcon, current: false },
